export const styles = {
    ...
    wrapperBefore: "block",
    navbar: "fixed top-0 left-0 flex items-start p-4 bg-gray-200 h-screen",
    prologue: "flex min-h-screen flex-col items-center justify-start p-24",
    starWarsIntro: "flex justify-center items-center h-screen bg-black text-yellow-400 overflow-hidden",
